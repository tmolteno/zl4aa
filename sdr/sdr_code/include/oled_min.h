...
/*
#define OLED_xfer_start     OLED_I2C_start(OLED_ADDR)
#define OLED_xfer_stop      OLED_I2C_stop
#define OLED_send_byte(b)   OLED_I2C_write(b)
#define OLED_data_stop      OLED_I2C_stop
#define OLED_command_stop   OLED_I2C_stop
*/
// Functions
void OLED_init(void);
